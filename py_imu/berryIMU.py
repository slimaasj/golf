...
class berryIMU(Node):
    ...
    def publish(self, event):
        ...
        imu_msg.angular_velocity = GYRx * DEG_TO_RAD
        imu_msg.angular_velocity = GYRy * DEG_TO_RAD
        imu_msg.angular_velocity = GYRz * DEG_TO_RAD
        imu_msg.linear_acceleration.x = ACCx * G
        imu_msg.linear_acceleration.y = ACCy * G
        imu_msg.linear_acceleration.z = ACCz * G
